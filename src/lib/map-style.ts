...
export const datavizMapStyle = `https://api.maptiler.com/maps/dataviz/style.json?key=${PUBLIC_MAPTILER_API_KEY}`;
...
export const positronMapStyle = {
	...
	sources: {
		openmaptiles: {
			type: 'vector',
			url: `https://api.maptiler.com/tiles/v3-openmaptiles/tiles.json?key=${PUBLIC_MAPTILER_API_KEY}`
		}
	},
	sprite: 'https://openmaptiles.github.io/positron-gl-style/sprite',
	glyphs: `https://api.maptiler.com/fonts/{fontstack}/{range}.pbf?key=${PUBLIC_MAPTILER_API_KEY}`,
	layers: [
		{
			id: 'background',
			type: 'background',
